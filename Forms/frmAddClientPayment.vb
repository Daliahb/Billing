Public Class frmAddClientPayment
    ...
    Private Sub btnSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSave.Click
        ...
        Try
            ...
            If Me.enumEditAdd = Enumerators.EditAdd.Add Then
                boolError = odbaccess.InsertClientPayment(lClientId, dblAmount, dblRecievedAmount, dDate, strNote, lNewBankID)
            ElseIf Me.enumEditAdd = Enumerators.EditAdd.Edit Then
                boolError = odbaccess.EditClientPayment(lPaymentId, lClientId, dblAmount, dblRecievedAmount, dDate, strNote, lNewBankID)
            End If
