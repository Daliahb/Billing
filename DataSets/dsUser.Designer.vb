...
Partial Public Class dsUser
    ...
    Partial Public Class UsersDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Public Overloads Function AddUsersRow(ByVal Username As String, ByVal Password As String, ByVal Active As ULong) As UsersRow
            Dim rowUsersRow As UsersRow = CType(Me.NewRow,UsersRow)
            Dim columnValuesArray() As Object = New Object() {Nothing, Username, Password, Active}
    ...
    Partial Public Class UsersTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM `Users` WHERE ((`ID` = @Original_ID) AND (`Username` = @Original_User" & _
                "name) AND (`Password` = @Original_Password) AND (`Active` = @Original_Active))"
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO `Users` (`Username`, `Password`, `Active`) VALUES (@Username, @Passwo" & _
                "rd, @Active)"
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE `Users` SET `Username` = @Username, `Password` = @Password, `Active` = @Ac" & _
                "tive WHERE ((`ID` = @Original_ID) AND (`Username` = @Original_Username) AND (`Pa" & _
                "ssword` = @Original_Password) AND (`Active` = @Original_Active))"
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "Select * from Users where Active=1" & Global.Microsoft.VisualBasic.ChrW(13) & Global.Microsoft.VisualBasic.ChrW(10) & "order by Username"
        ...
        Public Overloads Overridable Function Delete(ByVal Original_ID As Integer, ByVal Original_Username As String, ByVal Original_Password As String, ByVal Original_Active As ULong) As Integer
        ...
        Public Overloads Overridable Function Insert(ByVal Username As String, ByVal Password As String, ByVal Active As ULong) As Integer
        ...
        Public Overloads Overridable Function Update(ByVal Username As String, ByVal Password As String, ByVal Active As ULong, ByVal Original_ID As Integer, ByVal Original_Username As String, ByVal Original_Password As String, ByVal Original_Active As ULong) As Integer
            If (Username Is Nothing) Then
                Throw New Global.System.ArgumentNullException("Username")
            Else
            ...
            End If
            Me.Adapter.UpdateCommand.Parameters(6).Value = CType(Original_Active,ULong)
