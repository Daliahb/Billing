...
Public Class ColObjects
    ...
    Public Function GetCodeTypes() As ColObjects
        Dim obj As Obj
        obj = New Obj("TDM", Enumerators.CodeType.TDM)
        Me.Add(obj)
        obj = New Obj("CLI", Enumerators.CodeType.CLI)
        Me.Add(obj)
        obj = New Obj("Non CLI", Enumerators.CodeType.Non_CLI)
        Me.Add(obj)
        Return Me
    End Function
End Class
